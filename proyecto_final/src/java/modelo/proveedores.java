   ...
   //se creo la funcion agregar
    public int agregar(){
     ...
     try {
         ...
         cn = new Conexion();
         String query="INSERT INTO proyecto_final.proveedores(idProveedores,proveedor,nit,direccion,telefono)VALUES(?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modificar(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.proveedores SET idProveedores = ?,proveedor = ?,nit = ?,direccion = ?,telefono = ? WHERE idProveedores = ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
          parametro.setInt(1, getIdProveedores());
          parametro.setString(2, getProveedores());
