...
public class compras_detalle {
    ...
    try{
      ...
      cn.abrir_conexion();
        String query;
        query = "SELECT compras_detalle.idcompras_detalle, compras_detalle.idcompra, compras_detalle.idproducto, compras_detalle.cantidad, compras_detalle.precio_costo_unitario FROM proyecto_final.compras_detalle;";
   ...
   //se creo la funcion agregar
    public int agregar(){
     ...
     try {
         ...
         String query="INSERT INTO proyecto_final.compras_detalle(idcompras_detalle,idcompra,idproducto,cantidad,precio_costo_unitario)VALUES(?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modifica(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.compras_detalle SET idcompras_detalle = ?, idcompra = ?, idproducto = ?, cantidad = ?, precio_costo_unitario = ? WHERE idcompras_detalle = ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
