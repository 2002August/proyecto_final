...
public class compras extends compras_detalle{
    ...
    try{
      ...
      cn.abrir_conexion();
        String query;
        query = "SELECT compras.idcompra,compras.no_orden_compra,compras.idproveedor,compras.fecha_orden,compras.fechaingreso FROM proyecto_final.compras;";
   ...
   //se creo la funcion agregar
    public int agregar(){
     ...
     try {
         ...
         cn = new Conexion();
         String query="INSERT INTO proyecto_final.compras(idcompra,no_orden_compra,idproveedor,fecha_orden,fechaingreso)VALUES(?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modificar(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.compras SET idcompra = ?,no_orden_compra = ?,idproveedor = ?,fecha_orden = ?,fechaingreso = ? WHERE idcompra = ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
