   ...
   //se creo la funcion agregar
    ...
    public int agregar(){
     ...
     try {
         ...
         String query="INSERT INTO proyecto_final.empleados(idEmpleados,nombres,apellidos,direccion,telefono,DPI,genero,fecha_nacimiento,idPuesto,fecha_inicio_labores,fechaingreso)VALUES(?,?,?,?,?,?,?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modificar(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.empleados SET idEmpleados = ?,nombres = ?,apellidos = ?,direccion = ?,telefono = ?,DPI = ?,genero = ?,fecha_nacimiento = ?,idPuesto = ?,fecha_inicio_labores = ?,fechaingreso = ? WHERE idEmpleados = ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
