...
public class ventas_detalle{
    ...
    try{
      ...
      cn.abrir_conexion();
        String query;
        query = "SELECT ventas_detalle.idventas_detalle,ventas_detalle.idVenta,ventas_detalle.idProducto,ventas_detalle.cantidad,ventas_detalle.precio_unitario FROM proyecto_final.ventas_detalle;";
   ...
   //se creo la funcion agregar
    public int agregar(){
     ...
     try {
         ...
         String query="INSERT INTO proyecto_final.ventas_detalle(idventas_detalle,idVenta,idProducto,cantidad,precio_unitario)VALUES(?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modifica(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.ventas_detalle SET idventas_detalle = ?,idVenta = ?,idProducto = ?,cantidad = ?,precio_unitario = ? WHERE idventas_detalle= ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
