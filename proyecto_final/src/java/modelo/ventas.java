...
public class ventas extends ventas_detalle{
    ...
    try{
      ...
      cn.abrir_conexion();
        String query;
        query = "SELECT ventas.idVenta, ventas.nofactura, ventas.serie, ventas.fechafactura, ventas.idcliente, ventas.idempleado, ventas.fechaingreso FROM proyecto_final.ventas;";
   ...
   //se creo la funcion agregar
    public int agregar(){
     ...
     try {
         ...
         cn = new Conexion();
         String query="INSERT INTO proyecto_final.ventas (idVenta,nofactura,serie,fechafactura,idcliente,idempleado,fechaingreso)VALUES(?,?,?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modificar(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.ventas SET idVenta = ?,nofactura = ?,serie = ?,fechafactura = ?,idcliente = ?,idempleado = ?,fechaingreso = ? WHERE idVenta = ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
 ...
 public int eliminar (){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="delete from proyecto_final.ventas where idVenta=?;";   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
          parametro.setInt(1,getIdVenta());
          retorno = parametro.executeUpdate();
