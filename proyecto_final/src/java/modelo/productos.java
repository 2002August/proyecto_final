...
public class productos{
    ...
    try{
      ...
      cn.abrir_conexion();
        String query;
        query = "SELECT productos.idProductos, productos.producto, productos.idMarca, productos.descripcion, productos.Imagen, productos.precio_costo, productos.precio_venta, productos.existencia, productos.fecha_ingreso FROM proyecto_final.productos inner join marcas on productos.idMarca = marcas.idMarca;";
   ...
   //se creo la funcion agregar
    ...
    public int agregar(){
     ...
     try {
         ...
         cn = new Conexion();
         String query="INSERT INTO proyecto_final.productos(idProductos,producto,idMarca,descripcion,Imagen,precio_costo,precio_venta,existencia,fecha_ingreso)VALUES(?,?,?,?,?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modificar(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.productos SET idProductos = ?,producto = ?,idMarca = ?,descripcion = ?,Imagen =?,precio_costo = ?,precio_venta = ?,existencia = ?,fecha_ingreso =? WHERE idProductos = ?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
