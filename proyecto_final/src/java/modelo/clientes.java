...
public class clientes {
    ...
    cn.abrir_conexion();
    String query;
    query = "SELECT clientes.idClientes, clientes.nombres, clientes.apellidos, clientes.NIT, clientes.genero, clientes.telefono, clientes.correo_electronico, clientes.fechaingreso FROM proyecto_final.clientes;";
    ...
    public int agregar(){
     ...
     try {
         ...
         cn = new Conexion();
         String query="INSERT INTO proyecto_final.clientes(idClientes,nombres,apellidos,NIT,genero,telefono,correo_electronico,fechaingreso)VALUES(?,?,?,?,?,?,?,?);";   
         cn.abrir_conexion();
 ...
 return retorno;   
    ...
    public int modificar(){
     ...
     try {
         PreparedStatement parametro;
         cn = new Conexion();
         String query="UPDATE proyecto_final.clientes SET idClientes = ?,nombres = ?,apellidos = ?,NIT = ?,genero = ?,telefono = ?,correo_electronico = ?,fechaingreso = ? WHERE idClientes =?;" ;   
         cn.abrir_conexion();
         parametro = (PreparedStatement)cn.conexionBD.prepareStatement(query);
