...
INSERT INTO `clientes` VALUES (1,'Wualter','Hernandez','292987865',NULL,'87878738','usuario12@hotmail.com','2020-02-01 00:00:00'),(2,'Pedro','Lopez','298787878',_binary '','34432323','usuario12@hotmail.com','2020-02-01 00:00:00'),(3,'Juana','perez','343432333',NULL,'34545445','usuario12@hotmail.com','2020-02-01 00:00:00'),(4,'Lulu','sosa','343423233',NULL,'54654534','usuario12@hotmail.com','2020-02-01 00:00:00'),(5,'maria','pepe','876473838',NULL,'45456756','usuario12@hotmail.com','2020-02-01 00:00:00'),(6,'juan','lola','474673676',NULL,'34768767','usuario12@hotmail.com','2020-02-01 00:00:00'),(8,'Wualter','Hernandez','5464564',_binary '','87878738','usuario12@hotmail.com','2023-10-26 00:00:00'),(9,'Pedro','Lopez','3243242',_binary '','34432323','usuario12@hotmail.com','2023-10-28 00:00:00');
...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `id_proveedor_proveedores_empresa` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idproveedores`) ON UPDATE CASCADE
...
CREATE TABLE `compras_detalle` (
  ...
  CONSTRAINT `compras` FOREIGN KEY (`idcompras`) REFERENCES `compras` (`idcompras`) ON UPDATE CASCADE,
  CONSTRAINT `idproductos` FOREIGN KEY (`idproductos`) REFERENCES `productos` (`idproducto`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `empleados` (
  ...
  CONSTRAINT `id_puesto` FOREIGN KEY (`idpuesto`) REFERENCES `puestos` (`id_puesto`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `marcas` VALUES (1,'LOL'),(2,'LULU'),(3,'PEPE'),(4,'PAPE'),(5,'LITO'),(9,'poo');
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `marcas` FOREIGN KEY (`idmarca`) REFERENCES `marcas` (`idmarcas`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `puestos` VALUES (1,'GERENTE'),(2,'PROGRAMADOR'),(3,'SUPERVISOR'),(4,'VENTAS'),(5,'ANALISTA'),(10,'gerente');
...
INSERT INTO `usuarios` VALUES (1,'Augusto','2002');
...
CREATE TABLE `venta_detalle` (
  ...
  CONSTRAINT `venta` FOREIGN KEY (`idventa`) REFERENCES `ventas` (`idventas`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `clientes` FOREIGN KEY (`idcliente`) REFERENCES `clientes` (`id_cliente`) ON UPDATE CASCADE,
  CONSTRAINT `empleados` FOREIGN KEY (`idempleado`) REFERENCES `empleados` (`idempleado`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-07 14:43:20
